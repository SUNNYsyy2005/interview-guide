...
import {ChevronRight, FileStack, Moon, Settings, Sparkles, Sun, Users,} from 'lucide-react';
  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { id: 'interview-hub', path: '/interview-hub', label: '模拟面试', icon: Sparkles, description: 'AI 面试诊断练习' },
